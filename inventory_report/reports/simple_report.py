...
class SimpleReport:
    ...
    def generate(cls, list):
        ...
        for product in list:
            date_fab_list.append(
                date_to_seconds(product["data_de_fabricacao"])
            )
            date_exp_list.append(date_to_seconds(product["data_de_validade"]))
        ...
        company_products_index = companies_count_list.index(
